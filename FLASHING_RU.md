...
В общей конфигурации включены дисплеи и стандартный экран статуса ZMK.
...
установленного модуля. Работу нужно проверить на клавиатуре после новой сборки.
...
git add config/eyelash_sofle.conf build.yaml boards/arm/eyelash_sofle/eyelash_sofle.dtsi FLASHING_RU.md
git commit -m "Restore SSD1306 OLED support on both halves"
...
Этот успешный этап компиляции относился к старому варианту nice!view, не к новой
OLED-конфигурации. Для OLED локально проверяются матрица сборки, соответствие
параметров исторической конфигурации и формат diff. Полная компиляция новой версии
и проверка на физической клавиатуре ещё не выполнены: Docker Engine недоступен.
